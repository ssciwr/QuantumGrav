...
@testitem "test_make_simple_cset" tags = [:csetgeneration] setup = [setupTests] begin
    type = Float32
    cset, sprinkling =
        QuantumGrav.make_simple_cset("Minkowski", "CausalDiamond", 100, 2, rng, type = type)
...
@testitem "test_make_manifold_cset" tags = [:chebyshev_causets] setup = [setupTests] begin
    ...
    cset, sprinkling, chebyshev_coefs =
        QuantumGrav.make_manifold_cset(npoints, rng, order, r, 2, Float32)
...
@testitem "make_general_cset_works" tags = [:csetgeneration] setup = [setupTests] begin
    ...
    cset, sprinkling, chebyshev_coefs, manifold_like =
        QuantumGrav.make_general_cset(rng, npoints, order, r, d, Float32)
